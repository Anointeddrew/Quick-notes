    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-white">"
        <div className="container mx-auto px-4 py-8">
            <div className="text-center mb-16">
                ...
                <div className="flex flex-cool sm:flex-row gap-4 justify-center">
                    ...
                    <Link className="inline-flex items-center justify-center px-6 py-3 bg-white text-indigo-600 font-medium rounded-lg hover:bg-indigo-50 transition-colors"
                    to="/login">
                    Sign in</Link>
                </div>
            </div>
            ...
            <div className="grid mb:grid-cols-3 gap-8 max-w-5xl mx-auto">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <p className="text-gray-600">Clean and intuitive interface that lets you focus on what matters most.
                    </p>
                </div>
            </div>
        </div>
